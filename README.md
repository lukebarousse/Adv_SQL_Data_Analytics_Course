# 📊 Advanced SQL for Data Analytics - Full Course

Data Nerds! This repo contains all the files needed to follow along my free course: [Advanced SQL for Data Analytics]()
![]()
